  ...
  render() {
    return (
      <>
        ...
        <h4 className="text-center mt-5">Ainda sobre a Mineiração</h4>
        ...
        <div>
          <div className="col text-justify  mb-3">
            <div>
              ...
              bloco que o minerador escolheu. Os mineradores fazem isso, pois
              tem o interesse que os nós olhem para o bloco escolhido e
              atualizem suas blockchains com esse bloco. Antes de qualquer outra
              informação propagada, os nós tendem a olhar primeiro para as
              informações enviadas pelos mineradores, pois partem do pressuposto
              de que, se recursos foram gastos para chamar a atenção da rede
              para aquele bloco, as informações contidas neles devem estar
              verificadas e validadas, servindo assim de filtro da rede.
            </div>
          </div>
        </div>
